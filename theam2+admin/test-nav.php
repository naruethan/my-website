...
.navbar-primary .navbar-default .navbar-nav>li>a:focus, .navbar-default .navbar-nav>li>a:hover {
    color: #fff;
    background-color: rgba(15, 19, 76, 0.95);
}
...
.navbar-primary .navbar .nav .active > a {background-color: rgba(15, 19, 76, 0.95);}
.navbar-primary .navbar .nav .active > a,.navbar .nav .active > a:hover {color: #fff; background-color: #fff;}
...
<div class="navbar-primary">
 ...
 <div id="top" class="shadow">
     <ul class="nav navbar-nav">
       <li><a class="active" href="/theam2+admin/blank.php">หน้าแรก</a></li>
       <li><a href="/theam2+admin/blank.php">เกี่ยวกับเว็บไซต์</a></li>	  
	   <li><a href="/theam2+admin/blank.php">ค้นหา/ข้อมูลสถานที่ฝึกงาน</a></li>
       <li><a href="/theam2+admin/blank.php">สมัครเข้าร่วมโครงการสหกิจ</a></li>
	   <li><a href="/theam2+admin/blank.php">จัดการข้อมูลสมาชิก</a></li>
